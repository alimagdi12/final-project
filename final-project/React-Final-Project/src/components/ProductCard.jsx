  ...
  return (
    <Grid item xs={12} sm={4} md={4} lg={3} sx={{display:'flex'}}>
      ...
      >
        ...
        <CardActions>
          {!product?.expirationDate && (
            <Button  sx={{ width: '100%', backgroundColor: color ,color:'#FFF', '&:hover':{color:color , backgroundColor:'white', outline:`2px solid ${color}`}}}
            onClick={addToCart}>
              Add to Cart
            </Button>
          )}
          ...
          {product?.expirationDate && (
            <Button
            sx={{ width: '100%', backgroundColor: color ,color:'#FFF', '&:hover':{color:color , backgroundColor:'white', outline:`2px solid ${color}`}}}
            onClick={() => {
