    ...
    const validateField = (name, value) => {
        ...
        switch (name) {
            ...
            case 'location':
                ...
                break;
            case 'quantity':
                if (!value.trim()) errorMsg = 'Quantity is required';
                break;
            case 'productStatus':
                if (!value.trim()) errorMsg = 'Product Status is required';
                break;
            case 'categoryId':
                if (!value.trim()) errorMsg = 'Category is required';
                break;
            case 'price':
                if (!value.trim()) errorMsg = 'Price is required';
                break;
            case 'folderName':
                if (!value.trim()) errorMsg = 'Folder Name is required';
                break;
            default:
                break;
        }
