      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: "flex", md: "none" } }}>
            ...
            >
              <MenuItem sx={{fontWeight:'bold'}} onClick={() => { navigate('/products'); handleCloseNavMenu(); }}>
                <Typography textAlign="center">Products</Typography>
              </MenuItem>
              <MenuItem sx={{fontWeight:'bold'}} onClick={() => { navigate('/about'); handleCloseNavMenu(); }}>
                <Typography textAlign="center">About Us</Typography>
              </MenuItem>
              <MenuItem sx={{fontWeight:'bold'}} onClick={() => { navigate('/post'); handleCloseNavMenu(); }}>
              ...
              {categories && categories.categories && categories.categories.map((category) => (
                <MenuItem sx={{fontWeight:'bold'}} key={category._id} onClick={() => { navigate(`/products/${category._id}`); handleCloseNavMenu(); }}>
